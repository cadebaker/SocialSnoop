...
public class InstagramSnooper {
	 ...
	 ************************************************************/
	public InstagramSnooper() throws IOException, JSONException {
		...
		String access = "6188961345.8504729.30f2ce5d6865" + "4477a79cf32dbd94525b ";
...
//		post = getPosts(4);
	 ...
	 * 
	 * @param j
	 *            is the JSON object that holds the 'data' JSONArray within the
	 *            original JSON object.
	 * @return ArrayList that holds user information
	 * @throws JSONException
	 *             in case the JSON object breaks
	 **********************************************************************/
	...
	public static ArrayList<String> getPosts(final int postNum) throws IOException, JSONException {
		...
		/** String value that holds the access token. **/
		String accessCade = "241274222.8504729.5e561ee33eca44b1a6" + "75b41af138c063";

		/** Url to get user information **/
		URL url = new URL("https://api.instagram.com/v1/users/self" + "/media/recent?access_token=" + accessCade);
		...
		posts.add(post0.optJSONObject("caption").get("text").toString());
		posts.add(post0.optJSONObject("likes").get("count").toString());

		return posts;
	}

	/***************************************************************
	 * Gets the particular information the program needs from the user info.
	 * 
	 * @param index
	 *            is the information it needs.
	...
	/***************************************************************
	 * Gets the particular information the program needs from the post info.
	 * 
	 * @param index
	 *            is the information it needs.
	 * @return String value which is the information
